...
function FlexGrid(props){
  ...
  const flexItems = [
    ...
    {to: "/The-Venue", title: "The Venue", img: "/img/Backgrounds/venue.jpg", btnText: "Read More", subText: "<p>Vintage athletic club look</p><h4>Upscale-casual eatery</h4>", href: "/Venue/"},
    {to: "/About-Us", title: "About Us", img: "/img/Backgrounds/about_us.jpg", btnText: "Read More", subText: "<p>We like sports</p><h4>Meet Mike</h4>", href: "/About-Us/"},
